...
class RightTriangleButton(GameObject):
    def __init__(self):
        self.width = 50
        self.image = pygame.transform.scale(pygame.image.load('./assets/right_triangle.png'), (self.width, self.width))
        self.rect = self.image.get_rect()
...
class SquareButton(GameObject):
    def __init__(self):
        self.width = 50
        self.image = pygame.transform.scale(pygame.image.load('./assets/square.png'), (self.width, self.width))
        self.rect = self.image.get_rect()
...
class EquilateralTriangleButton(GameObject):
    def __init__(self):
        self.width = 50
        self.image = pygame.transform.scale(pygame.image.load('./assets/equilateral_triangle.png'),
...
class RhombusButton(GameObject):
    def __init__(self):
        self.width = 50
        self.image = pygame.transform.scale(pygame.image.load('./assets/rhombus.png'), (self.width, self.width))
        self.rect = self.image.get_rect()
...
class RightTriangle(GameObject):
    def __init__(self, init_point, *args, **kwargs):
        ...
        self.color = current_color
        self.end_point = Point(*init_point)
        self.rect = pygame.Rect(self.start_point.x, self.start_point.y, self.end_point.x - self.start_point.x,
    ...
    def draw(self, surf):
        ...
        pygame.draw.line(surf, self.color, (self.start_point.x, self.start_point.y), (third_point_x, third_point_y),
                         width=5)
        pygame.draw.line(surf, self.color, (third_point_x, third_point_y), (self.end_point.x, self.end_point.y),
                         width=5)
        pygame.draw.line(surf, self.color, (self.start_point.x, self.start_point.y),
                         (self.end_point.x, self.end_point.y), width=5)

    def update(self, curr_point):
        self.end_point.x, self.end_point.y = curr_point
        start_point_x = min(self.start_point.x, self.end_point.x)
        start_point_y = min(self.start_point.y, self.end_point.y)
        self.rect = pygame.Rect(start_point_x, start_point_y, abs(self.end_point.x - self.start_point.x),
...
class Square(GameObject):
    def __init__(self, init_point, *args, **kwargs):
        ...
        self.end_point = Point(*init_point)
        self.color = current_color
        self.rect = pygame.Rect(self.start_point.x, self.start_point.y, abs(self.start_point.x - self.end_point.x),
...
def main():
    ...
    objects = [rect_button, circle_button, eraser_button, brush_button, right_triangle_button, square_button,
               eq_triangle_button, rhombus_button, red_button, blue_button, green_button, black_button]
